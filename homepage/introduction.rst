...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/kleine_geistliche_konzerte.git
...
* `Heinrich Schütz – Kleine Geistliche Konzerte <https://github.com/DCMLab/kleine_geistliche_konzerte/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first concerto, Eile mich, Gott, zu erretten, of the first volume, Op. 8 has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/op08n01swv282_Eile_mich,_Gott,_zu_erretten.tsv')
   notes = ms3.load_tsv('notes/op08n01swv282_Eile_mich,_Gott,_zu_erretten.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/kleine_geistliche_konzerte/issues>`__ and feel free to fork and submit pull requests.
